...
export default function LoginPage() {
  const [email, setEmail] = useState("admin@saksham.ai");
  const [password, setPassword] = useState("saksham2026");
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isLocalApi && email === "admin@saksham.ai" && password === "saksham2026") {
        login(
          {
            id: "demo-admin-001",
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            ...
            <p className="text-[hsl(var(--muted-foreground))] text-lg leading-relaxed mb-8">
              12 autonomous agents. Zero false positives. Real exploitability validation.
        ...
        >
          ...
          <div className="p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 mb-6">
            <div className="flex items-center gap-2 mb-1">
              <Sparkles className="w-3.5 h-3.5 text-emerald-500" />
              <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400">Demo Mode Active</span>
            </div>
            <p className="text-xs text-[hsl(var(--muted-foreground))]">
              Email: <code className="text-emerald-600 dark:text-emerald-400">admin@saksham.ai</code> · Password: <code className="text-emerald-600 dark:text-emerald-400">saksham2026</code>
            </p>
          </div>
